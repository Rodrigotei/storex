                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 items-start">
                            <div class="shrink-0">
                                ...
                                <img src="{{ $category->img ? Storage::url($category->img) : asset('img/default.png') }}" class="w-24 h-24 object-cover rounded-2xl border-2 border-slate-200 dark:border-gray-800 shadow-sm">
                            </div>
