                ...
                <tbody class="divide-y divide-slate-100 dark:divide-gray-800">
                    @forelse ($products as $product)
                        <tr class="hover:bg-slate-50/50 dark:hover:bg-gray-800/30 transition-colors group">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <img src="{{ asset($product->productImages->first() ? Storage::disk('s3')->url($product->productImages->first()->img) : 'img/default.png')}}" class="w-15 h-15 object-cover rounded" alt="Imagem do produto" srcset="">
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
