                        ...
                        <div class="flex gap-4 items-start">
                            @for ($i = 0; $i < count($product->productImages); $i++)
                                <div class="flex flex-col gap-1 items-center">
                                    <img src="{{ $product->productImages[$i]->img ? Storage::url($product->productImages[$i]->img) : asset('img/default.png') }}" class="w-24 h-24 object-cover rounded-2xl border-2 border-slate-200 dark:border-gray-800 shadow-sm">
